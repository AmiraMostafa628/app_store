...
class ChangeCartProductsUseCase extends UseCase<ChangeFavCartModel,int>{
  final HomeRepo _homeRepo;

  ChangeCartProductsUseCase(this._homeRepo);

  @override
  Future<Either<Failure, ChangeFavCartModel>> execute(int param) async {
    return await _homeRepo.changeCartProducts(param);
  }
